...
import EquationEditor.Display.AddComponent;
...
public class BuildTree {
    ...
    public static Stack parseString(String expression, Stack outputStack) throws org.nfunk.jep.ParseException {
        if (expression.equals("")) {
            outputStack.add(new EquationEditor.Tree.Text(expression));
        } else {
    ...
    public static Stack convertJEPTree(Node currentNode, Stack outputStack, String expression) {
        ...
        if (currentNode.getClass().getName().equals("org.nfunk.jep.ASTVarNode")) {
            ...
            if (varNode.getName().length() > 1) {
                outputStack.push(new EquationEditor.Tree.Text(varNode.getName()));
            } else {
...
//                    outputStack.push(new Variable('\u221e', "Variable"));
    ...
    public static void toTree(MathObject currentNode, Stack currentStack) {
        ...
        if (currentStack.empty() != true) {
            ...
            if (currentNode.getClass().getName().equals("EquationEditor.Tree.NaryFunction")) {
            ...
            } else if (currentNode.getClass().getName().equals("EquationEditor.Tree.BinaryOperator")) {
            ...
            } else if (currentNode.getClass().getName().equals("EquationEditor.Tree.NaryOperator")) {
            ...
            } else if (currentNode.getClass().getName().equals("EquationEditor.Tree.Function")) {
            ...
            } else if (currentNode.getClass().getName().equals("EquationEditor.Tree.Grouping")) {
            ...
            } else if (currentNode.getClass().getName().equals("EquationEditor.Tree.Matrix")) {
