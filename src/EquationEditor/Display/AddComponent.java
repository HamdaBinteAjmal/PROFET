...
public class AddComponent {
     ...
     */
    public AddComponent(InputComponent[] inputComponents, JPanel jPanelWorkspace, BuildTree buildTree, MouseListener textBoxListener, StatusBar statusBar, LanguageManager langMan, boolean implicitMult, boolean keepAsDouble) {
                    ...
                    if (layer.getComponent(i+1).getBackground() != MseSelectListener.SELECT) {
                        ...
                        if (i==0) {
                            ...
                            if ((layer.getComponent(i-1).getClass().getName().equals("javax.swing.JPanel") ||
                                    layer.getComponent(i-1).getClass().getName().equals("EquationEditor.Display.TextBox")) &&
